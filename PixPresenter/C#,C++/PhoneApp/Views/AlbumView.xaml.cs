...
namespace PixPresenter
{
    public partial class AlbumView : ViewBase
    {
        ...
        void BuildLocalizedApplicationBar()
        {
            ...
            appBarButton = new ApplicationBarIconButton(new Uri("/Assets/AppBar/appbar.edit.rest.png", UriKind.Relative));
            appBarButton.Text = Strings.Caption_AppBarConvert;
            appBarButton.Click += Convert_Click;
            ApplicationBar.Buttons.Add(appBarButton);

            appBarButton = new ApplicationBarIconButton(new Uri("/Assets/AppBar/share.png", UriKind.Relative));
            appBarButton.Text = "Share";
            appBarButton.Click += Send_Click;
            ApplicationBar.Buttons.Add(appBarButton);
        }
